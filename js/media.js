document.addEventListener("DOMContentLoaded", () => {
    ...
    interactionStyles.textContent = `
        ...
        .talvaren-overlay-caption {
            ...
            color: #f3e6c8;
            text-align: center;
            background: rgba(20,18,15,.90);
            border: 1px solid rgba(216,197,162,.36);
            border-radius: 8px;
        }

        .talvaren-overlay-caption h2 {
            margin: 0 0 5px;
            font-size: 1.35rem;
        }
    ...
    overlay.innerHTML = `
        ...
        <div class="talvaren-overlay-caption">
            <h2></h2>
            <p></p>
        </div>
    `;
    ...
    const overlayTitle = overlay.querySelector(
        ".talvaren-overlay-caption h2"
    );
    ...
    function updateOverlayCaption(media) {

        overlayTitle.textContent = media.title;
        overlayDescription.textContent = media.description;
    }
