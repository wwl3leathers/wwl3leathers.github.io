...
const CACHE_NAME = `${CACHE_PREFIX}r40`;
...
const CORE = [
  ...
  "js/navigation.js?v=20260814-1", "js/site-shell.js?v=20260814-1", "js/components/modal-viewer.js", "js/pages/tool-catalog.js", "js/pages/toolbox.js",
